...
wget --no-check-certificate https://raw.githubusercontent.com/guidetuanhp/3proxy/main/archive/3proxy-0.9.4.tar.gz
...
cd /etc/3proxy/
wget --no-check-certificate https://raw.githubusercontent.com/guidetuanhp/3proxy/main/3proxy_no_auth.cfg
